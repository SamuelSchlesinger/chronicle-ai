...
pub struct PendingCharacterList {
    pub receiver: std::sync::Mutex<
        std::sync::mpsc::Receiver<
            Result<Vec<chronicle_core::CharacterSaveInfo>, chronicle_core::persist::PersistError>,
        >,
    >,
}
