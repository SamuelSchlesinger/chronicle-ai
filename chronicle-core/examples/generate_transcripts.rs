...
//!
//! Run with: `cargo run -p chronicle-core --example generate_transcripts`

use chronicle_core::headless::{HeadlessConfig, HeadlessGame};
use chronicle_core::world::{Background, CharacterClass, RaceType};
use std::fs;
use std::path::Path;
...
async fn run_scenario(
    ...
    // Footer
    transcript.push_str(&format!(
        "*This transcript was generated by [chronicle-ai](https://github.com/SamuelSchlesinger/chronicle-ai), \
